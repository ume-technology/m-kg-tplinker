...
train_config = {
    "train_data": "../in_data_data4bert/train_data.json",
    "valid_data": "../in_data_data4bert/valid_data.json",
    "rel2id": "rel2id.json",
...
# linux
bert_config = {  # F:\Pictures\m-kg-tplinker\\\\
    "data_home": "/mnt/f/Pictures/m-kg-tplinker/TPlinker_chn/baidu_relation/duie-data/in_data_data4bert",
    "bert_path": "/mnt/f/Pictures/bigfiles/premodelfiles/hflchinese-bert-wwm-ext",
    "hyper_parameters": {
        "lr": 5e-5,
    },
}
# windows
# bert_config = {
#     "data_home": r"F:\Pictures\m-kg-tplinker\TPlinker_ycy\TPLinker\data4bert",
