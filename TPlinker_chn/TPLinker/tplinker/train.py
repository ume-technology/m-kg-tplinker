...
# from TPlinker_chn.TPLinker.tplinker.common.utils import Preprocessor, DefaultLogger
# from TPlinker_chn.TPLinker.tplinker.tplinker import (HandshakingTaggingScheme,
#                                                      DataMaker4Bert,
#                                                      DataMaker4BiLSTM,
#                                                      TPLinkerBert,
#                                                      TPLinkerBiLSTM,
#                                                      MetricsCalculator)
# import wandb
# import TPlinker_chn.TPLinker.tplinker.config as config
...
preprocessor = Preprocessor(tokenize_func=tokenize, get_tok2char_span_map_func=get_tok2char_span_map)  # 构建处理的函数
