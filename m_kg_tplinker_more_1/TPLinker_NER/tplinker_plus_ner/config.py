...
bert_config = {
    ...
    "bert_path": r"F:\Pictures\bigfiles\premodelfiles\hflchinese-bert-wwm-ext",  # windows
    # "bert_path": "/mnt/f/Pictures/bigfiles/premodelfiles/hflchinese-bert-wwm-ext",  # bert-base-cased， bert-base-chinese # todo change  linux
    "hyper_parameters": {
        "lr": 5e-5,
    },
}
