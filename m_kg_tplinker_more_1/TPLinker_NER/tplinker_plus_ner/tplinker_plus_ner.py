...
import math
# todo change
from m_kg_tplinker_more_1.TPLinker_NER.common.components import HandshakingKernel  # todo windows


# from common.components import HandshakingKernel  # todo Linux
...
class HandshakingTaggingScheme(object):
    def __init__(self, entity_type2id, max_seq_len):
        ...
        self.shaking_idx2matrix_idx = [
            (ind, end_ind) for ind in range(self.matrix_size) for end_ind in list(range(self.matrix_size))[ind:]
        ]
