...
### 数据集
- 该项目本身给出了数据集的下载地址；
- https://zhuanlan.zhihu.com/p/189254722
- https://github.com/thunlp/OpenNRE/blob/master/benchmark/download_nyt10.sh
- Dir-data4tplinker-standard unzip from data4tplinker.tar.gz; 是项目给定的整理好的数据集；
